...
- Automatic algorithm selection based on resource instances

### 📊 **Interactive D3.js Visualization**

- Real-time graph rendering with smooth animations
- Color-coded nodes: Blue (Safe) / Red (Deadlocked) / Purple (Resources)
- Green solid arrows = Allocations, Yellow dashed = Requests
- Interactive legend and tooltips

### 📝 **Educational Step-by-Step Traces**

- Complete algorithm execution logs
- Shows Work vector updates in matrix detection
- Displays cycle detection process in WFG
- Learn by seeing each calculation step

### 🔧 **Smart Recovery Strategies**

- Minimal process termination sets
- Resource preemption suggestions with rollback details
- Multiple recovery options ranked by complexity
- What-if simulation for each strategy

### 💾 **5 Pre-loaded Sample Datasets**

- Circular Deadlock (3-process cycle)
- Safe State (no deadlock)
- Multi-Instance Deadlock
- Partial Deadlock (some safe, some deadlocked)
- Complex Safe State (5 processes)

### 🖥️ **Modern Web Interface**

- No installation required - runs in browser
- Responsive design (desktop, tablet, mobile)
- Editable allocation/request matrices
